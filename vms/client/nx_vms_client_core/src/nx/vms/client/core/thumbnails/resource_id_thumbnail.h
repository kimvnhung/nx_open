 ...
 */
class ResourceIdentificationThumbnail: public AbstractCachingResourceThumbnail
{
    Q_OBJECT
    ...
    using base_type = AbstractCachingResourceThumbnail;
...
protected:
    virtual std::unique_ptr<AsyncImageResult>
