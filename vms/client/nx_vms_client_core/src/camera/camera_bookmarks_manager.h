...
public:
    ...
    /**
     * @brief Requests bookmarks on the top or bottom of the currently known ones. Calculates
     * tail (new bookmarks over the old one) and body (old/updated/new bookmarks inside current
     * range).
     * @param filter Filter parameters.
